...
class PristonTaleApp(App):
    def build(self):
        ...
        for eq in equip_list:
            eq_line = BoxLayout(size_hint_y=None, height=40, spacing=5)
            eq_line.add_widget(Label(text=eq, font_name=f_name))
            eq_line.add_widget(TextInput(multiline=False, font_name=f_name))
            content.add_widget(eq_line)
